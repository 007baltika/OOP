...
class Time:
    ...
    @property
    def hours(self):
        self._hours = (self._hours % 24) + (self._minutes // 60)  
        return self._hours 
    
    @hours.setter
    def hours(self, other):
        self._hours = self.hours + other.hours    
    ...
    def minutes(self, other):
        self._minutes = self.minutes + other.minutes
    ...
    def __iadd__(self, other): 
        if isinstance(other, Time):
            # self = Time(self.hours + other.hours, self.minutes + other.minutes)
            self._hours = self.hours + other.hours
            self._minutes = self.minutes + other.minutes 
            return self
        return NotImplemented
