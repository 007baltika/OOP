...
class Vector:
    ...
    def __mul__(self, n):
        if isinstance(n, (int, float)): return Vector(self.x * n, self.y * n)
        return NotImplemented 
    ...
    def __rmul__(self, n):
        if isinstance(n, (int, float)): return self.__mul__(n)
        return NotImplemented 
    
    def __rtruediv__(self, n):
        if isinstance(n, (int, float)): return self.__truediv__(n)
        return NotImplemented 
