...
class DateFormatter:
    ...
    def __call__(self, date):
        if self.country_code == 'ru': return date.strftime('%d.%m.%Y')
        if self.country_code == 'us': return date.strftime('%m-%d-%Y')
        if self.country_code == 'ca': return date.strftime('%Y-%m-%d')
        if self.country_code == 'br': return date.strftime('%d/%m/%Y')
        if self.country_code == 'fr': return date.strftime('%d.%m.%Y')
        if self.country_code == 'pt': return date.strftime('%d-%m-%Y')
