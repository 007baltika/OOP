...
#РАЗОБРАТЬСЯ ПОЧЕМУ НЕ РАБОТАЕТ @TOTAL_ORDERING!!!!!


class FuzzyString(str):
    
    def __new__(cls, stroka):
        return super().__new__(FuzzyString, stroka.lower())
    
    def __eq__(self, other):
        if isinstance(other, str):
            return super().__str__() == other.lower()
        elif isinstance(other, FuzzyString):
            return super().__str__() == other
